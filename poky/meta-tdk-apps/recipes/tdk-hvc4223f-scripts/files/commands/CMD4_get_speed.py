...
cmd_1_list  = [0x04,0x01]  # mot 1 get motor speed in electrical revolutions per minute [rpm]
...
speed = int.from_bytes(answer[2:4], "little")
...
cmd_1_list  = [0x04,0x02]  # mot 1 get motor speed in electrical revolutions per minute [rpm]
