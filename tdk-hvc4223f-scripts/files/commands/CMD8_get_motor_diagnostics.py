...
cmd_1_list  = [0x08,0x01]  # mot 1 get motor speed in electrical revolutions per minute [rpm]
...
cmd_1_list  = [0x08,0x02]  # mot 1 get motor speed in electrical revolutions per minute [rpm]
